...
void Graphics::Render()
{
  ...
  for(int i = 0; i < m_world.masterList.size(); i++)
  {
    glUniformMatrix4fv(m_modelMatrix, 1, GL_FALSE, glm::value_ptr( m_world.masterList[i]->GetModel() ));
    m_world.masterList[i]->Render();
  }
